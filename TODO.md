...
#### 1. **🔒 프로필/닉네임 변경권 제한 시스템** ⭐⭐⭐⭐⭐
- [ ] **1회 무료 변경 시스템**
  - [ ] 사용자별 변경 횟수 추적 (profileChangeCount, displayNameChangeCount)
  - [ ] 첫 변경 후 편집 버튼 비활성화 (회색 처리)
  - [ ] 변경 시도 시 "땅콩으로 구매" 팝업 표시
- [ ] **땅콩 결제 시스템 연동**
  - [ ] 변경권 구매 다이얼로그 (프로필 이미지: 50땅콩, 닉네임: 30땅콩)
  - [ ] 땅콩 잔액 확인 및 차감
  - [ ] 결제 완료 후 변경 가능 상태로 전환
