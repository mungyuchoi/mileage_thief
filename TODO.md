...
### ❌ 미완성 기능 (다음 우선순위)
- [ ] 게시글 작성/수정/삭제
- [ ] 댓글 HTML 렌더링 (flutter_html 패키지 추가)
- [ ] 답글/멘션 기능 완성
- [ ] 마이페이지 완성
- [ ] 등급 시스템 및 업그레이드 기능
...
**Firebase Storage 구조:**
```
posts/{yyyyMMdd}/posts/{postId}/comments/{commentId}/images/{commentId}_{uuid}.{ext}
```

**이미지 업로드 플로우:**
1. 사용자가 이미지 선택 (image_picker)
2. Firebase Storage에 업로드
3. 업로드된 URL을 HTML에 삽입
4. 댓글 저장 시 HTML과 첨부파일 목록 함께 저장
...
dependencies:
  ...
  flutter_html: ^3.0.0           # HTML 렌더링 (선택사항)
```
