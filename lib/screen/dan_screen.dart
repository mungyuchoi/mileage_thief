...
class _SearchDanScreen extends State<SearchDanScreen> {
  ...
  Widget build(BuildContext context) {
    print('빌드: _interstitialAd =  [33m [1m [4m [7m' +
        (_interstitialAd == null ? 'null' : '존재') +
        '\u001b[0m');
    return Scaffold(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const CancellationNotificationScreen(),
                          ),
                        );
                      },
                      child: Column(
                  ...
                  children: <Widget>[
                      ...
                      children: [
                        FloatingActionButton.extended(
                          onPressed: _interstitialAd == null || isLoading
                              ? null
                              : () async {
                                  print('전면광고 버튼 클릭: _interstitialAd = ' +
                                      (_interstitialAd == null
                                          ? 'null'
                                          : '존재'));
                                  ...
                                  if (result == true) {
                                    ...
                                    try {
                                      ...
                                      print(
                                          '전면광고 사용 후 _interstitialAd = null, _loadFullScreenAd() 호출');
                                      _loadFullScreenAd();
                                    }
                                  }
                                },
                        ...
                        FloatingActionButton.extended(
                          ...
                          label: const Text("+ 30",
                              style: TextStyle(color: Colors.black87)),
                          backgroundColor: _rewardedAd == null
                              ? Colors.grey[300]
                              : Colors.white,
                          elevation: 3,
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final int requiredPeanuts =
                            (xAlign == loginAlign) ? 3 : 5;
                        ...
                        if (xAlign == -1.0) {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      SearchDetailDanRoundScreen(SearchModel(
                                          isRoundTrip:
                                              xAlign == -1.0 ? true : false,
                                          departureAirport:
                                              departureSelectedValue,
