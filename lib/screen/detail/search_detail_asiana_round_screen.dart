...
class SearchDetailAsianaRoundScreen extends StatefulWidget {
  final SearchModel searchModel;
  const SearchDetailAsianaRoundScreen(this.searchModel, {super.key});

  @override
  State<SearchDetailAsianaRoundScreen> createState() => _SearchDetailAsianaRoundScreenState();
}

class _SearchDetailAsianaRoundScreenState extends State<SearchDetailAsianaRoundScreen> {
  ...
  Future<List<MileageV2>> _getItems(SearchModel searchModel, {bool isReturn = false}) async {
    return await MileageRepository.getAsianaMileagesV2(searchModel);
  }
}
