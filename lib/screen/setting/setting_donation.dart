...
import 'package:mileage_thief/screen/setting/consumable_store.dart';

const List<String> _kProductIds = <String>[
  'donation1000', 'donation5000', 'donation10000', 'donation50000'
];
class SettingDonation extends StatefulWidget {
  const SettingDonation({super.key});

  @override
  State<StatefulWidget> createState() => SettingDonationState();
}
class SettingDonationState extends State<SettingDonation> {
