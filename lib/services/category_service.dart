...
class CategoryService {
  ...
  List<Map<String, dynamic>> _getDefaultBoards() {
    return const [
      ...
      {'id': 'aeroroute_news', 'name': 'AeroRoutes', 'group': '뉴스', 'description': 'AeroRoutes 항공 노선 소식', 'order': 7.1, 'icon': 'public', 'fabEnabled': false},
      {'id': 'secretflying_news', 'name': 'SecretFlying', 'group': '뉴스', 'description': 'SecretFlying 특가 항공권 소식', 'order': 7.2, 'icon': 'public', 'fabEnabled': false},
